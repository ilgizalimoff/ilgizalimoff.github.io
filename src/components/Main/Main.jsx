    ...
    <div className="main">
      <div className="main_container">
        ...
        <div className="description">
          Я Алимов Ильгиз Ринатович. Этот сайт позволит тебе больше узнать обо мне.
          Здесь будут или уже выложены все мои приложения для ознокомления работодателями.
        </div>
      </div>
    </div>
  );
